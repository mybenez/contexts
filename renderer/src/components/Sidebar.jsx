...
const Sidebar = ({ showSidebar, activeMenu, setActiveMenu }) => {
  const menuItems = [
    ...
    { id: 'articles', name: 'Books', icon: 'M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z' },
            ...
            <li key={item.id}>
              <button
                ...
                className={`flex items-center w-full px-4 py-3 rounded-lg transition-colors ${
                  activeMenu === item.id ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-700'
                }`}
              >
